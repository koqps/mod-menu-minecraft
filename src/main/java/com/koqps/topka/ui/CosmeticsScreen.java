...
public final class CosmeticsScreen extends Screen {
    ...
    private static final List<CosmeticEntry> ARMOR_SETS = List.of(
            ...
            new CosmeticEntry("Valentine Armor Set", "Valentine armor with animated high-detail accents.", 3)
    );
    ...
    private static final List<CosmeticEntry> ARMOR = List.of(
            ...
            new CosmeticEntry("Valentine", "Pink/gold armor plus animated cosmetic details.", 3)
    );
    ...
    public void extractRenderState(GuiGraphicsExtractor g, int mouseX, int mouseY, float delta) {
        ...
        g.text(font, UiFont.text("Cosmetics 0.14.3"), 616, 477, 0xFF686879, true);
